// Create a method named countVowels that takea String as input and convert it into  an array ofcharacters  and returns the number of vowels in the array.
//Furthermore, the method should throw a checked exception if thearray contains the letter 'x'.//
/*@AkashSingh */

import java.util.Scanner;

public class CountVowels {  int countVowels(String str) {
